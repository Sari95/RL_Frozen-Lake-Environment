...
## Sarah Schürch, Jacobsen Brandenborg
## Original file is located at https://colab.research.google.com/drive/1OVTDSapWSR1WiW22tZ2uxKX1oMFM41op
...
# Carried out for the FrozenLake environment on a 5x5- and 11x-11 grid.
...
# -------------------------------
# The same for 11×11 Environment & Training
# -------------------------------
...
# Learning Curve: Shows only the Success Rate
